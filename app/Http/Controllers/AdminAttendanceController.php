...
class AdminAttendanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $yearsss = EmployeeRecord::distinct()->get(['year']); // gets in Json form
        ...
        //echo abc;
        //$newemployes = EmployeeRecord::all();
        $newemp = User::find($idd);
        $name = $newemp->name;
        $iddd = $newemp->id;
        ...
        ->with('ThisYear',$ThisYear)
        ->with('Thismonthis',$Thismonthis)
        ->with('ThisMonth',$ThisMonth)
        ->with('y',$y)
        ->with('AllYearsInDB',$AllYearsInDB);
    ...
    public function store(Request $request)
    {
        ...
        if($check == 1){
            ...
            $TheEmploye = EmployeeRecord::find($theNewID);
