...
class EmployeeAttendanceManagementController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $newemployess = EmployeeRecord::all();
        ...
        ->with('attendd',$attend)
        ->with('newemployess',$newemployess)
        // ->with('newcharts',$newcharts)
        ->with('year2',$year2);
    ...
    public function show($id)
    {
        ...
        $record = EmployeeRecord::where('user_id', $id)
        ->where('status', 'P')
        ->where('day', $date)
        ->latest()
        ->first();
        ...
        $holidayrecord = EmployeeRecord::where('user_id', $id)
        ->where('status', 'H')
        ->where('day', $date)
        ->latest()
        ->first();
        ...
        $leaverecord = EmployeeRecord::where('user_id', $id)
        ->where('status', 'L')
        ->where('day', $date)
        ->latest()
        ->first();
        ...
        elseif($holidayrecord){
            
            Session::flash('warning', 'Cheers!! It is your holiday today!!');
            return view('pages.notification');
        }
        elseif($leaverecord){
            Session::flash('warning', 'You take a leave today!!');
            return view('pages.notification');
            // print "You take a leave today!!";
        }
        else{
            
            Session::flash('warning', 'Please give attendance!!!');
            return view('pages.notification');
            // print "Please give attendance!!!";
        }
    }
