                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('user-management.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                    <input id="role" type="radio" class="{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" value="admin" required autofocus>Admin
                            ...
                            <div class="col-md-6">
                                <input id="role1" type="radio" class="{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" value="user" required autofocus>User
