...
@section('action-content')
    <!-- Main content -->
    <section class="content" style="background-color: #cfd8dc;">
      <div class="box" style="background-color: #cfd8dc;">
  <div class="box-header" style="background-color: #cfd8dc;">
    <div class="row">
        <div class="col-sm-8">
  ...
  <div class="box-body" style="background-color: #cfd8dc;">
      <div class="row">
        <div class="col-sm-6" style="background-color: #cfd8dc;"></div>
        <div class="col-sm-6" style="background-color: #cfd8dc;"></div>
      </div>
      <form method="POST" action="{{ route('department.search') }}" style="background-color: #cfd8dc;">
         {{ csrf_field() }}
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tbody style="background-color: #b0bec5;">
            ...
            <!-- <tfoot style="background-color: #607d8b;">
              <tr>
